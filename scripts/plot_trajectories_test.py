#
# plot_trajectories_test.py
#

"""
Optimize trajectories on both SEIRD/R-SEIRD on three test-set counties and plot them.
...
def main(show):
    ...
    Notes:
        Figure saved to figs/testcomparecem.pdf
    """
    ...
    plt.savefig(opj('./figs', 'testcomparecem.pdf'))
